...
import { ExternalLink, ShieldCheck, Cpu, Radio } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <CyphraLogo variant="badge" size="sm" href="/" />
            <span className="hidden sm:inline text-xs text-zinc-200">|</span>
            <span className="text-xs text-zinc-600">
              Confidential payments on{' '}
              <span className="text-black font-bold">Midnight Network</span> with{' '}
              <span className="text-black font-bold">1AM Wallet</span>
            </span>
          </div>
        ...
        {/* ── Sub-footer Row ── */}
        <div className="mt-8 pt-5 border-t border-[#FFD400]/20 flex flex-col sm:flex-row items-center justify-between text-[11px] text-zinc-500 font-mono gap-3">
