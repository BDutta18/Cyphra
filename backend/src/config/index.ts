...
const contractAddress = (process.env.CONTRACT_ADDRESS && process.env.CONTRACT_ADDRESS.trim()) || (process.env.CYPHRA_CONTRACT_ADDRESS && process.env.CYPHRA_CONTRACT_ADDRESS.trim()) || DEFAULT_PREPROD_CONTRACT_ADDRESS;
